...
insert into Cidade (id, nome, uf) values (4, 'Porto Nacional', 'TO');
...
insert into Endereco (id, logradouro, cidade_id, cliente_id) values (1, 'Rua 1', 1, 1);
insert into Endereco (id, logradouro, cidade_id, cliente_id) values (2, 'Rua 1', 1, 2);
insert into Endereco (id, logradouro, cidade_id, cliente_id) values (3, 'Rua 2', 2, 3);
